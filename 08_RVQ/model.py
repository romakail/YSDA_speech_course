...
class MNISTEncoderDecoder(L.LightningModule):
    def __init__(self, quantizer: Optional[nn.Module] = None, vq_loss: Optional[nn.Module] = None):
        ...
        # self.encoder = Encoder(in_channels=1, num_hiddens=32, num_residual_layers=2, num_residual_hiddens=4)
        # self.decoder = Decoder(in_channels=32, num_hiddens=32, num_residual_layers=2, num_residual_hiddens=4)
